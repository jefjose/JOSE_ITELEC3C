<nav x-data="{ open: false }" class="bg-white border-b border-gray-100"> <!-- Primary Navigation Menu --> <div
    ...
    <x-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
        ...
        <x-slot name="trigger">
            ...
            font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50
            ...
            <x-slot name="content">
                ...
                <div class="block px-4 py-2 text-xs text-gray-400">
                        ...
                        <x-dropdown align="right" width="48">
                            ...
                            <button
                                ...
                                <svg class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
                                    ...
                                    stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4
                                    18h16" />
                    ...
                    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden"> <div class="pt-2 pb-3
                        space-y-1"> <x-responsive-nav-link href="{{ route('dashboard') }}"
